...
<div class="container mx-auto px-4 py-8">
    <h1 class="text-3xl font-bold mb-2">Dashboard Secretaria</h1>
    <p class="text-gray-600 mb-8">{{ $resumo['entidade']['nome'] ?? 'Secretaria' }}</p>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold @if($resumo['kpis']['saldo_secretaria'] >= 0) text-green-600 @else text-red-600 @endif">
                        R$ {{ number_format($resumo['kpis']['saldo_secretaria'], 0, ',', '.') }}
                    </p>
                </div>
                <div class="@if($resumo['kpis']['saldo_secretaria'] >= 0) text-green-600 @else text-red-600 @endif opacity-20">
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center justify-between">
                ...
                <div class="text-purple-600 opacity-20">
                    <x-heroicon-o-clock class="w-16 h-16" />
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 gap-8 mt-8">
        ...
        <div class="bg-white rounded-lg shadow p-6">
            ...
            @include('components.chart', [
                'chartId' => 'fluxo_caixa_secretaria_' . uniqid(),
