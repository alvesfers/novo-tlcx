...
<div class="container mx-auto px-4 py-8">
    <!-- Header -->
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-gray-900 dark:text-white mb-2">Criar Função</h1>
        <p class="text-gray-600 dark:text-gray-400">Adicionar nova função ou cargo para dirigentes</p>
    </div>

    <!-- Form Card -->
    <div class="rounded-2xl border border-gray-200 bg-white p-8 dark:border-white/[0.05] dark:bg-white/[0.03] max-w-2xl">
        <form action="{{ route('funcoes-dirigentes.store') }}" method="POST">
            @csrf
