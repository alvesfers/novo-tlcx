<div class="relative" x-data="{
    ...
    <div
        ...
        class="absolute mt-[17px] flex flex-col rounded-2xl border border-gray-200 bg-white p-3 shadow-theme-lg dark:border-gray-800 dark:bg-gray-dark z-50 inset-x-4 sm:inset-x-auto sm:w-[260px] sm:right-0"
        style="display: none;"
    >
        <!-- User Info -->
        <div>
