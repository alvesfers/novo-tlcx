                            ...
                            <td class="px-6 py-3.5">
                                <div class="flex items-center gap-3">
                                    ...
                                    <button onclick="openModal('dioceseModal', true, {
                                        ...
                                        ativo: {{ $diocese->ativo ? 'true' : 'false' }}
                                    })"
    ...
    <script>
        function diocesesManager() {
            return {
                ...
                deleteSelected() {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            fetch('/dioceses/delete-multiple', {
                                method: 'POST',
                                body: formData,
                                headers: {
                              ...
                              .then(data => {
                                  if (data.success) {
                                      Swal.fire({
                                          icon: 'success',
                                          title: 'Sucesso!',
                                          text: 'Dioceses deletadas com sucesso!',
                ...
                deleteItem(dioceseId, event) {
                    event.preventDefault();
                    Swal.fire({
                        icon: 'warning',
                        title: 'Confirmar exclusão',
                        text: 'Tem certeza que deseja deletar esta diocese?',
                        showCancelButton: true,
                        confirmButtonColor: '#d33',
                        confirmButtonText: 'Deletar',
                        cancelButtonText: 'Cancelar'
