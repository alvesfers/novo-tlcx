    ...
    <div class="overflow-hidden rounded-2xl border border-gray-200 bg-white dark:border-white/[0.05] dark:bg-white/[0.03]">
        ...
        <div class="flex flex-col gap-4 px-6 py-4 sm:flex-row sm:items-center sm:justify-between border-b border-gray-100 dark:border-white/[0.05]">
            ...
            <div class="flex items-center gap-3">
                ...
                <button onclick="openModal('nucleoModal', false)"
                        ...
                        <tr class="border-b border-gray-100 dark:border-white/[0.05] hover:bg-gray-50 dark:hover:bg-white/[0.02]" data-row-id="{{ $nucleo->id }}">
                            ...
                            <td class="px-6 py-3.5">
                                <div class="flex items-center gap-3">
                                    ...
                                    <button onclick="openModal('nucleoModal', true, {
                                        id: {{ $nucleo->id }},
                                        entidade_pai_id: {{ $nucleo->entidade_pai_id }},
                                        nome: '{{ addslashes($nucleo->nome) }}',
                                        email: '{{ addslashes($nucleo->email ?? '') }}',
                                        ativo: {{ $nucleo->ativo ? 'true' : 'false' }}
                                    })"
    ...
    <script>
        function nucleosManager() {
            return {
                              ...
                              .then(data => {
                                  if (data.success) {
                                      Swal.fire({
                                          icon: 'success',
                                          title: 'Sucesso!',
                                          text: 'Núcleos deletados com sucesso!',
                ...
                deleteItem(nucleoId, event) {
                    event.preventDefault();
                    Swal.fire({
                        icon: 'warning',
                        title: 'Confirmar exclusão',
                        text: 'Tem certeza que deseja deletar este núcleo?',
                        showCancelButton: true,
                        confirmButtonColor: '#d33',
                        confirmButtonText: 'Deletar',
                        cancelButtonText: 'Cancelar'
