...
<body class="bg-gray-50">
    <div class="min-h-screen flex items-center justify-center py-12 px-4">
        <div class="w-full max-w-2xl">
            ...
            <div class="bg-white rounded-lg shadow-lg p-8 md:p-12">
                ...
                <!-- Formulário -->
                <form id="formularioDirigente" class="space-y-6">
                    @csrf
                    ...
                    @empty
                        <div class="text-center py-8 text-gray-600">
                            <p>Nenhum campo de formulário configurado para dirigentes neste evento.</p>
                        </div>
                    @endforelse
    ...
    <script>
        const formulario = document.getElementById('formularioDirigente');
