...
<div class="container mx-auto px-4 py-8">
    <div class="overflow-hidden rounded-2xl border border-gray-200 bg-white dark:border-white/[0.05] dark:bg-white/[0.03]">
        ...
        <div class="flex flex-col gap-4 px-6 py-4 sm:flex-row sm:items-center sm:justify-between border-b border-gray-100 dark:border-white/[0.05]">
            ...
            <button onclick="openModal('categoriaModal')"
                ...
                <tbody>
                    ...
                    <tr class="border-b border-gray-100 dark:border-white/[0.05] hover:bg-gray-50 dark:hover:bg-white/[0.02]">
                        ...
                        <td class="px-6 py-3.5">
                            <span class="inline-block px-3 py-1 rounded-full text-xs font-semibold @if($categoria->ativo) bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-200 @else bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-200 @endif">
                        ...
                        <td class="px-6 py-3.5">
                            <div class="flex items-center gap-3">
                                ...
                                <form action="{{ route('almoxarifado-categorias.destroy', $categoria) }}" method="POST" style="display: inline;">
                                    @csrf @method('DELETE')
...
<x-modal-form
    ...
    resource="almoxarifado-categorias"
    size="md"
>
    <div class="space-y-4">
        <div>
