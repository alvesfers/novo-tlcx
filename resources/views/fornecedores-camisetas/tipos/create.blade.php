...
<div class="container mx-auto px-4 py-8">
    <div class="mb-8">
        ...
        <p class="text-gray-600 dark:text-gray-400">Criar novo tipo para {{ $fornecedor->nome }}</p>
    </div>

    <div class="rounded-2xl border border-gray-200 bg-white p-8 dark:border-white/[0.05] dark:bg-white/[0.03] max-w-2xl">
        <form action="{{ route('fornecedores-camisetas.tipos.store', $fornecedor) }}" method="POST">
            @csrf
